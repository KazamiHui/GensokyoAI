...
class CommandParser:
    ...
    def _register_builtin_tags(self) -> None:
        """注册内置标签"""
        # 提示词标签（这些会传递给 AI）
        self.register_tag("know", aliases=["knowledge"], cmd_type=CommandType.PROMPT,
                         description="提供参考资料给 AI")
        self.register_tag("meta", aliases=["metadata"], cmd_type=CommandType.PROMPT,
                         description="提供元数据（场景、设定等）")
        self.register_tag("attention", aliases=["tips"], cmd_type=CommandType.PROMPT,
                         description="提醒/纠正 AI 的扮演")
        
        # 系统命令标签
        self.register_tag("cmd", aliases=["command"], cmd_type=CommandType.SYSTEM,
                         description="执行系统命令")
        self.register_prefix("exit", cmd_type=CommandType.SYSTEM, description="退出程序")
        self.register_prefix("quit", cmd_type=CommandType.SYSTEM, description="退出程序")
        self.register_prefix("back", cmd_type=CommandType.SYSTEM, description="回滚对话")
        self.register_prefix("new", cmd_type=CommandType.SYSTEM, description="新会话")
        self.register_prefix("save", cmd_type=CommandType.SYSTEM, description="保存会话")
        self.register_prefix("sessions", cmd_type=CommandType.SYSTEM, description="列出会话")
        self.register_prefix("help", cmd_type=CommandType.SYSTEM, description="显示帮助")
